...
componentWillMount() {
	...
	//alert(crypt.decrypt(cookies.get('subCategoryCount')))
  this.setState({
    subCategoryName:crypt.decrypt(cookies.get('subCategoryName')),
    categoryCount:crypt.decrypt(cookies.get('subCategoryCount')),
    pageNaviCount:Math.round(crypt.decrypt(cookies.get('subCategoryCount')) / 100)
  })
	const data = {
...
// const categories =
		...
		return(
			<div className="products-wrapper">
				<div className="container" style={{paddingTop:'90px', width:'100%',margin:'0px auto'}} id="startchange1">
				        <div className={styles.shopLandpage}>
				          <div>
									<div className={styles.FeaturedCategorieNavigationDiv}>
				             <div><h2 style={{textTransform: 'capitalize'}}>{this.state.subCategoryName}</h2></div>
                  ...
                  <div className={styles.FeaturedCategorieDiv}>
                    {productsData}
									...
									<div className={styles.FeaturedCategorieNavigationDiv}>
									<div><h2 style={{textTransform: 'capitalize'}}></h2></div>
										<div className={styles.pagination} style={{display:this.showPagination(100),marginLeft:'10px'}}>
											<a href="#" onClick={this.pageNavigationFirst.bind(this,0)}>&laquo;</a>
												 <a href="#" onClick={this.pageNavigationPrev.bind(this,this.state.offset)}>&lsaquo;</a>
													 {this.renderPageNavigation(this.state.categoryCount)}
												 <a href="#" onClick={this.pageNavigationNext.bind(this,this.state.offset)}>&rsaquo;</a>
