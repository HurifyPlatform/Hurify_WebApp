        ...
        <div className="modal" ref="modal">
          ...
          <div className="quick-view">
            <div className="quick-view-image"><img src={this.props.product.image} alt={this.props.product.name}/></div>
						<div>Description: Residents across India will have to take the necessary precautions to avoid heat-related illnesses this week as the first major heat wave grips the country. Residents across India will have to take the necessary precautions to avoid heat-related illnesses this week as the first major heat wave grips the country. </div>
