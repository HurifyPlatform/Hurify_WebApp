...
class PrivacyPolicyNew extends React.Component {
  ...
  hide(e) {
    e.preventDefault()
    ModalStore.setDisplayed('privacy_policy_dashboard', false)
  }
  render() {
  return(
    <div className={resendStyles.formContainer + (ModalStore.modalDisplayed['privacy_policy_dashboard'] == false ? (' ' + resendStyles.close) : '')}>
