...
import styles from './ClientProfileUpdate.css'
import $ from "jquery";
...
class ClientProfileUpdate extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            params: {
	...
	return(
      ...
      <form onSubmit={this.updatingProfile}>
			<div className={styles.well} style={{margin:'50px 50px 50px 80px'}}>
              ...
              <div className="col-sm-6">
                  <div className="form-group">
                      <label htmlFor="lname" className={styles.fieldname}>First Name<span className="kv-reqd">*</span></label>
                      <input type="text" className="form-control" name="firstName" value={this.state.firstName} onChange={this.changesName} required />
                  </div>
              </div>
								<div className="col-sm-6">
									<div className="form-group">
											<label htmlFor="email" className={styles.fieldname}>Last Name</label>
...
ClientProfileUpdate.contextTypes = {
